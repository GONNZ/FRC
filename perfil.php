                ...
                <div class="container">
                    <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
                        ...
                        <li class="nav-item" style="position: relative;left: 436px;">
                            ...
                            <!-- Button modal -->
                            <button type="button" class="btn btn-success btn-sm mb-2 ml-6" data-toggle="modal" data-target="#exampleModalScrollable">
                                ...
                                <div class="modal-dialog modal-lg modal-dialog-scrollable" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Omnis harum eaque soluta obcaecati esse praesentium enim voluptatibus eligendi modi fuga repudiandae, incidunt, aliquam tempora et ducimus quibusdam deleniti. Reprehenderit, doloremque?
                                        </div>
